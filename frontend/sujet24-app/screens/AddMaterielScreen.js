...
export default function AddMaterielScreen({ navigation }) {
  const [nMateriel, setNMateriel] = useState('');
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      const res = await API.addMateriel({
      ...
      if (res.ok) {
        showAlert({
          type: 'success',
          title: 'Materiel ajoute !',
          message: '"' + design.trim() + '" a ete enregistre avec succes.',
          confirmText: 'OK',
        ...
        showAlert({
          type: 'error',
          title: 'Erreur',
          message: data.error || 'Une erreur est survenue lors de l\'ajout.',
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.card}>
        <Text style={styles.sectionTitle}>Informations du materiel</Text>
        ...
        <View style={styles.inputRow}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Ex: Ordinateur Dell Latitude"
            value={design}
        ...
        >
          {loading ? (
            ...
            <>
              ...
              <Text style={styles.submitBtnText}>Enregistrer le materiel</Text>
            </>
          )}
        </TouchableOpacity>
